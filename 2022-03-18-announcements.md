...
### Training Site Release
The Training Website was updated on April 15. We added a new [Workshop History](https://training.nih-cfde.org/en/latest/Release-Notes/history/) page under the Release Notes tab that contains a list of all workshops organized by the CFDE training and coordination team. This page links to workshop resources such as websites and video recordings. We also added an image summarizing the total number of workshops and participants. Over 1300 people have attended CFDE trainings! We hope this new page makes it easier to find information from previous workshops. If you think a workshop is missing, please [email the training team](mailto:CFDE-HelpDesk%20%3Ctraining@cfde.atlassian.net) or [open an issue](https://github.com/nih-cfde/training-and-engagement/issues/new).
